...
@onready var fl_leg = $"Spider Rig/FrontLeftIKTarget"
@onready var fr_leg = $"Spider Rig/FrontRightIKTarget"

@onready var bl_leg = $"Spider Rig/BackLeftIKTarget"
@onready var br_leg = $"Spider Rig/BackRightIKTarget"
